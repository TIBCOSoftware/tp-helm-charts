...
{{- define "bw6-webserver.consts.appName" }}tp-cp-bw6-webserver{{ end -}}

{{/* Component we're a part of. */}}
{{- define "bw6-webserver.consts.component" }}cp{{ end -}}
...
{{- define "bw6-webserver.cp-env-configmap" }}cp-env{{ end -}}
...
{{- define "bw6-webserver.shared.labels.chartLabelValue" -}}
...
*/}}
{{- define "bw6-webserver.shared.labels.selector" -}}
app.kubernetes.io/name: {{ include "bw6-webserver.consts.appName" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
app.kubernetes.io/instance: {{ .Release.Name }}
app.cloud.tibco.com/owner: {{ include "bw6-webserver.cp-instance-id" . }}
{{- end -}}
...
*/}}
{{- define "bw6-webserver.shared.labels.standard" -}}
{{ include  "bw6-webserver.shared.labels.selector" . }}
helm.sh/chart: {{ include "bw6-webserver.shared.labels.chartLabelValue" . }}
...
{{- define "bw6-webserver.image.registry" }}
    {{- include "cp-env.get" (dict "key" "CP_CONTAINER_REGISTRY" "default" "reldocker.tibco.com" "required" "false" "Release" .Release )}}
{{- end }}


{{/* set repository based on the registry url. We will have different repo for each one. */}}
{{- define "bw6-webserver.bwce.image.repository" -}}
  {{- include "cp-env.get" (dict "key" "CP_CONTAINER_REGISTRY_REPO" "default" "tibco-platform-docker-prod" "required" "false" "Release" .Release )}}
{{- end -}}

{{/* set repository based on the registry url. We will have different repo for each one. */}}
{{- define "bw6-webserver.integration.image.repository" -}}
  {{- include "cp-env.get" (dict "key" "CP_CONTAINER_REGISTRY_REPO" "default" "tibco-platform-docker-prod" "required" "false" "Release" .Release )}}
{{- end -}}
...
{{- define "bw6-webserver.container-registry.secret" }}
...
{{- define "bw6-webserver.cp-instance-id" }}
...
{{- define "bw6-webserver.cp-logging-fluentbit-enabled" }}
...
{{- define "bw6-webserver.cp-otel-services" }}
...
{{- define "bw6-webserver.enableResourceConstraints" -}}
