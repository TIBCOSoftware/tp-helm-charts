...
Common labels
*/}}
{{- define "dp-bw5ce-app.labels" -}}
helm.sh/chart: {{ include "dp-bw5ce-app.chart" . }}
{{ include "dp-bw5ce-app.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "dp-bw5ce-app.selectorLabels" -}}
app.kubernetes.io/name: {{ include "dp-bw5ce-app.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
platform.tibco.com/name: {{ include "dp-bw5ce-app.fullname" . }}
{{- end }}

{{/*
BW app deployment labels
*/}}
{{- define "dp-bw5ce-app.bwapp.deployment.labels" -}}
platform.tibco.com/app-name: {{ include "dp-bw5ce-app.fullname" . }}
...
platform.tibco.com/buildtype-base-image: {{ .Values.appConfig.bw5ceBaseImageTag | quote }}
platform.tibco.com/buildtype-version: {{ .Values.appConfig.bw5ceBuildTypeTag | quote }}
...
*/}}
{{- define "dp-bw5ce-app.bwapp.deployment.annotations" -}}
...
BW app pod labels
*/}}
{{- define "dp-bw5ce-app.bwapp.pod.labels" -}}
app: bw5ce-app
app.kubernetes.io/instance: {{ include "dp-bw5ce-app.fullname" . }}
platform.tibco.com/app-name: {{ include "dp-bw5ce-app.fullname" . }}
platform.tibco.com/app-version: {{ .Values.appConfig.appVersion | quote }}
platform.tibco.com/capability-instance-id: {{ .Values.dpConfig.capabilityInstanceId | quote }}
platform.tibco.com/name: {{ include "dp-bw5ce-app.fullname" . }}
...
*/}}
{{- define "dp-bw5ce-app.bwapp.pod.annotations" -}}
