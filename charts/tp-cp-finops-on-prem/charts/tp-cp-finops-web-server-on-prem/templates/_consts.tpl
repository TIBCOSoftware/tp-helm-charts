...
{{- define "tp-cp-finops-web-server.consts.appName" }}tp-cp-finops-web-server{{ end -}}

{{/* A fixed short name for the configmap */}}
{{- define "tp-cp-finops-web-server.consts.configMapName" }}tp-cp-finops-web-server-configmap{{ end -}}

{{/* Component we're a part of. */}}
{{- define "tp-cp-finops-web-server.consts.component" }}finops{{ end -}}

{{/* Team we're a part of. */}}
{{- define "tp-cp-finops-web-server.consts.team" }}tp-finops{{ end -}}

{{/* Namespace we're going into. */}}
{{- define "tp-cp-finops-web-server.consts.namespace" }}{{ .Release.Namespace}}{{ end -}}

{{- define "tp-cp-finops-web-server.tp-control-plane-dnsdomains" }}tp-control-plane-on-prem-dnsdomains{{ end -}}
{{- define "tp-cp-finops-web-server.tp-finops-dnsdomains-configmap" }}tp-cp-finops-dnsdomains{{ end -}}
