...
{{- define "tp-cp-finops-service.consts.appName" }}tp-cp-finops-service{{ end -}}

{{/* Tenant name. */}}
{{- define "tp-cp-finops-service.consts.tenantName" }}finops{{ end -}}

{{/* Component we're a part of. */}}
{{- define "tp-cp-finops-service.consts.component" }}finops{{ end -}}

{{/* Team we're a part of. */}}
{{- define "tp-cp-finops-service.consts.team" }}tp-finops{{ end -}}

{{/* Namespace we're going into. */}}
{{- define "tp-cp-finops-service.consts.namespace" }}{{ .Release.Namespace}}{{ end -}}

{{- define "tp-cp-finops-service.tp-finops-dnsdomains-configmap" }}tp-cp-finops-dnsdomains{{ end -}}
