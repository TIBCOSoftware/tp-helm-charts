...
{{- define "tp-cp-monitoring-service.consts.appName" }}tp-cp-monitoring-service{{ end -}}

{{/* Tenant name. */}}
{{- define "tp-cp-monitoring-service.consts.tenantName" }}finops{{ end -}}

{{/* Component we're a part of. */}}
{{- define "tp-cp-monitoring-service.consts.component" }}finops{{ end -}}

{{/* Team we're a part of. */}}
{{- define "tp-cp-monitoring-service.consts.team" }}tp-finops{{ end -}}

{{/* Namespace we're going into. */}}
{{- define "tp-cp-monitoring-service.consts.namespace" }}{{ .Release.Namespace}}{{ end -}}
{{- define "tp-cp-monitoring-service.tp-env-configmap" }}tp-control-plane-on-prem-dnsdomains{{ end -}}

{{- define "tp-cp-monitoring-service.tp-finops-dnsdomains-configmap" }}tp-cp-finops-dnsdomains{{ end -}}
