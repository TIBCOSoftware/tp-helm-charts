...
{{- define "resource-set-operator.consts.deploymentName" }}tp-cp-resource-set-operator{{ end -}}

{{/* Tenant name. */}}
{{- define "resource-set-operator.consts.tenantName" }}cp-core{{ end -}}

{{/* Component we're a part of */}}
{{- define "resource-set-operator.consts.component" }}platform-bootstrap{{ end -}}
