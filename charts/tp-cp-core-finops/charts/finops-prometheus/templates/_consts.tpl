...
{{- define "finops-prometheus.consts.appName" }}tp-cp-finops-prometheus{{ end -}}

{{/* Tenant name. */}}
{{- define "finops-prometheus.consts.tenantName" }}finops{{ end -}}

{{/* Component we're a part of. */}}
{{- define "finops-prometheus.consts.component" }}finops{{ end -}}

{{/* Team we're a part of. */}}
{{- define "finops-prometheus.consts.team" }}tp-finops{{ end -}}

{{/* Namespace we're going into. */}}
{{- define "finops-prometheus.consts.namespace" }}{{ .Release.Namespace}}{{ end -}}
{{- define "finops-prometheus.tp-env-configmap" }}tp-cp-core-dnsdomains{{ end -}}
