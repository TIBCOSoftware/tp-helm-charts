...
{{- define "o11y-service.jaeger-collector-endpoint" }}jaeger.{{ .Values.global.cp.resources.serviceaccount.namespace }}.svc.cluster.local:{{ .Values.global.cp.resources.o11y.tracesServer.config.collector.port }}{{ end -}}
