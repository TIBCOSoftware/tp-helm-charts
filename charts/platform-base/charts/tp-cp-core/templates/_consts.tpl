...
{{- define "tpcontrol-plane.consts.cpQueryNodeServiceName" -}}
    ...
    {{- else }}
        {{- "querynode."}}{{ .Values.global.tibco.controlPlaneInstanceId }}{{ "-tibco-cp.svc.cluster.local" -}}
    {{- end -}}
{{ end -}}
...
{{- define "tpcontrol-plane.consts.docBaseUrl" }}https://docs.tibco.com/go/platform-cp/1.12.0/doc/html{{ end -}}
