...
#
# TIBCO Control Plane Helm Values Generation Script for Platform Upgrade FROM 1.18.0 TO 1.19.0
...
FROM_VERSION="${FROM_VERSION:-1.18.0}"
TO_VERSION="1.19.0"
...
process_files() {
    ...
    print_info "Applying transformations for 1.19.0..."

    # TODO: Add version-specific yq transformations here
    # Examples:
    # yq eval 'del(.some.deprecated.field)' -i "${CONTROL_PLANE_OUTPUT_FILE}"
